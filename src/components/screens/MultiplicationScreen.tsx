        ...
        {(difficulty === 'easy' || difficulty === 'medium') && problem && (
          <div className="circle-representation-box">
            <div className="visual-representation">
              ...
              <CircleRepresentation count={problem.operands[0]} operation="multiplication" representationType="operand" />
              <span className="math-symbol">×</span>
              <CircleRepresentation count={problem.operands[1]} operation="multiplication" representationType="operand" />
              <span className="math-symbol">=</span>
              {isCorrect === true && <CircleRepresentation count={problem.answer} operation="multiplication" representationType="result" />}
            </div>
          </div>
        )}
